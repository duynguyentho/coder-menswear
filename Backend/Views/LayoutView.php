...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>CoderMenswear</b></span>
        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=blogs&action=read">
                        <i class="fa fa-th"></i> <span>Quản lí blog</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=customers&action=read">
